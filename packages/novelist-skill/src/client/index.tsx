 ...
 *
 * @module @ai-novelist/novelist-skill/client
 */
...
export const name = 'ai-novelist-client'
...
export const COMPOSER_TAB_ID = 'ai-novelist/composer'

/** The kind `openTab` names to open this composer page. */
export const COMPOSER_TAB_KIND = 'ai-novelist'
